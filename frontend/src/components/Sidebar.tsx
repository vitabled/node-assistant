...
export type Tab =
  | "dashboard" | "deploy" | "certs" | "f2b-list" | "rkn-scanners" | "templates" | "hosts" | "traffic" | "settings" | "mihomo" | "configs" | "bridges" | "auto"
...
const NAV_MAIN: NavItemDef[] = [
  ...
  // Сканеры RKN/ТСПУ, найденные на нодах — рядом с Fail2Ban, тот же домен прав.
  { tab: "rkn-scanners", label: "RKNscanner",   Icon: ScanSearch,  domain: "deploy"     },
